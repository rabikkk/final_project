...
\chapter{KOMUTLAR ve İŞLEVLERİ}
	...
	EED4093 Research Project Dersi için için latex preamble'ı
	\begin{verbatim}
	 \documentclass[research]{deutez}
	\end{verbatim}
	şeklinde başlamalıdır.
	
	EED4094 Final Project Dersi için için latex preamble'ı
	\begin{verbatim}
	 \documentclass[thesis]{deutez}
	\end{verbatim}
	şeklinde başlamalıdır.
